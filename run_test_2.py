...
for i_eps in range(n_eps_min,n_eps_max):
    ...
    # mass_mul = [1.,1.+epsmul,1.+2*epsmul,1.+epsmul]
    mass_mul = [1.,1.,1.,1.]
    nTf = [1,1,1,1]
    nbs = [1,1,1,1]
    nbf = [1,1,1,1]
    ...
    # mass = np.array([1.,1.+epsmul,1.+2*epsmul,1.+epsmul],dtype=np.float64)
    mass = np.array([1.,1.+2*epsmul,1.+epsmul,1.+2*epsmul],dtype=np.float64)
