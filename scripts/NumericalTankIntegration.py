...
# 
    ...
    if Save_ODE_anim:
        ...
        ActionSyst_small.plot_all_2D_anim(nint_plot=nint_anim,filename=filename_output,fig_size=vid_size,dnint=dnint,all_pos_trace=all_pos,all_pos_points=all_pos)
