...
def main():
    ...
    # for name in ['2D-Circle']:
        ...
        NBS, params_buf = tests.test_config.Sols_dict[name]

        doit(name, NBS, params_buf)
...
def doit(name, NBS_in, params_buf_in):
    ...
    for i_eig in tqdm.tqdm(range(n_eig)):
        ...
        alpha = 30./Instability_magnitude[0]
        ...
        # NBS.plot_all_2D_anim(allpos, filename, color="body")
        NBS.plot_all_2D_anim(allpos, filename, color="body", xlim=xlim, Max_PathLength=Max_PathLength)
