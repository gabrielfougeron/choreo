...
def main(preprint_msg=''):
    ...
    while (n_opt < n_opt_max):
        ...
        all_coeffs_avg = Gen_init_avg_mul_loops(nTf,nbs,nbf,mass_mul,ncoeff,all_coeffs_slow_load,all_coeffs_fast_load,callfun,Rotate_fast_with_slow,Optimize_Init,Randomize_Fast_Init)        
