...
cdef inline (double, double, double) CCpt_interbody_pot(double xsq):  # xsq is the square of the distance between two bodies !
    ...
    cdef double pot = -cpow(xsq,n)
    cdef double potp = -n*cpow(xsq,nm1)
    cdef double potpp = -nnm1*cpow(xsq,nm2)
    
    return pot,potp,potpp
    
@cython.boundscheck(False)
@cython.wraparound(False)
cdef inline (double, double, double) CCpt_interbody_pot_new(double xsq):  # xsq is the square of the distance between two bodies !
