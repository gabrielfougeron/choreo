...
class ExactKrylovJacobian(Jacobian):
    r"""
    Custom hacky modifications
    """

    def __init__(self, method='lgmres', inner_maxiter=20,
                 inner_M=None, outer_k=10,gradmatvec = None, **kw):
    ...
    def setup(self, x, f, func, gradmatvec):
        Jacobian.setup(self, x, f, func)
        self.x0 = x
        self.f0 = f
        self.gradmatvec = gradmatvec
        self.op = scipy.sparse.linalg.aslinearoperator(self)
