...
```
pyodide build && cp ./dist/choreo-1.0.0-cp311-cp311-emscripten_3_1_45_wasm32.whl ./choreo_GUI/python_dist/choreo-1.0.0-cp311-cp311-emscripten_3_1_45_wasm32.whl
```
